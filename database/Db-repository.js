...
import { StyleSheet, ScrollView, ActivityIndicator, View, List, ListItem, Text, Card, Button  } from 'react-native';
...
class Rides extends Component {
    ...
    componentDidMount() {
        ...
        const ref = firebase.firestore().collection('db').doc('rides');
        ref.get().then((doc) => {
          if (doc.exists) {
            this.setState({
              board: doc.data(),
